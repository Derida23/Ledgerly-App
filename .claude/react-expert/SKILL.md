...
| React Router v7 | `references/react-router-v7.md` | SPA mode, file-based routing, loaders, params, layouts |
| View Transitions | `references/view-transitions.md` | Page slide animation, shared element transitions |
| Better Auth | `references/better-auth.md` | Auth client, OAuth, session hooks, RBAC |
| PWA | `references/pwa.md` | Manifest, service worker, offline, push notifications |
| TanStack Query | `references/tanstack-query.md` | Query keys, caching, invalidation, mutations, pagination |
| React Hook Form + Zod | `references/react-hook-form-zod.md` | Form validation, conditional fields, shadcn integration |
| Tailwind + shadcn/ui | `references/tailwind-shadcn.md` | Theming, dark mode, responsive patterns, components |
